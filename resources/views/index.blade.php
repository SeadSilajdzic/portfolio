...
<header id="header" class="d-flex flex-column justify-content-center">
    ...
    <nav id="navbar" class="navbar nav-menu">
        <ul>
            ...
            @auth
                <li><a href="{{ route('logout') }}" class="nav-link scrollto"><i class="bx bx-log-out"></i> <span>Logout</span></a></li>
            @endauth
        </ul>
    </nav><!-- .nav-menu -->
...
<main id="main">
    ...
    <section id="about" class="about">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <img src="{{ $info->featured }}" class="img-fluid" alt="">
                </div>
                <div class="col-lg-8 pt-4 pt-lg-0 content">
                    <h3>{{ $info->role_title }}</h3>
                    <p class="fst-italic">
                        {!! $info->short_note !!}
                    </p>
                    <div class="row">
                        <div class="col-lg-6">
                            <ul>
                                <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>{{ $info->birthday->toFormattedDateString() }}</span></li>
                                ...
                                <li><i class="bi bi-chevron-right"></i> <strong>Location:</strong> <span>{{ $info->city }}</span></li>
                            </ul>
                        </div>
                        <div class="col-lg-6">
                            <ul>
                                <li><i class="bi bi-chevron-right"></i> <strong>Age:</strong> <span>{{ $info->age }}</span></li>
                                <li><i class="bi bi-chevron-right"></i> <strong>Education:</strong> <span>{{ $info->education }}</span></li>
                                <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>{{ $info->mail }}</span>
                                </li>
                                <li><i class="bi bi-chevron-right"></i> <strong>Status:</strong> <span>{{ $info->status }}</span></li>
                                @if($info->cv)
                                    <li><i class="bi bi-chevron-right"></i> <strong>CV:</strong> <span>{{ $info->cv }}</span></li>
                                @endif
                            </ul>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('contact.store') }}" method="post">
                        ...
                        <div class="form-group">
                            <div class="text-center">
                                <button type="submit" name="btn-contact-dev" class="btn btn-primary btn-lg mt-3 h-50 w-25 rounded-pill">Send Message</button>
                            </div>
                        </div>
                    </form>
